!(function (r) {
    r.fn.simpleSendForm = function (a) {
        (a = r.extend(
            {
                successTitle: "Thanks for choosing us!",
                successText: "We will contact you shortly.",
                errorTitle: "Message not sent!",
                errorSubmit: "Form submission error!",
                errorNocaptcha: "Вы не заполнили каптчу",
                errorCaptcha: "Вы не прошли проверку каптчи",
                mailUrl: "/forms/submit.php",
                autoClose: !1,
                autoCloseDelay: 5e3,
                debug: !1,
                captcha: !1,
            ...
            (window.onload = function () {
                ...
                (e.src = "https://www.google.com/recaptcha/api.js"), document.body.appendChild(e);
            });
        return this.each(function () {
            var i = r(this),
                ...
                o = i.find(".btn-submit"),
                e = i.find(".recaptcha");
            a.captcha && e.append('<div class="g-recaptcha" data-sitekey="' + a.captchaPublicKey + '"></div>'),
                r(this).submit(function () {
                    var e = r(this).serialize();
                    function t(e) {
                        o.parents(n).removeClass("sending"),
                            i.append('<div class="form__error alert alert-danger text-center">' + e + "</div>"),
                            setTimeout(function () {
                    ...
                    return (
                        r.ajax({
                            ...
                            data: e,
                            beforeSend: function () {
                                o.parents(n).addClass("sending");
                            },
                            success: function (e) {
                                1 == e
                                    ? (i[0].reset(),
                                      a.captcha && grecaptcha.reset(),
                                      i.find(".form__hide-success").slideUp().delay(5e3).slideDown(),
                                      o.parents(".form__form").removeClass("sending"),
                                      i.find(".form__hide-success").after('<div class="form__sys-message alert alert-success text-center"></div>'),
                                      i.find(".form__sys-message").html('<h4 class="form__success-title">' + a.successTitle + '</h4><p class = "form__success-text" >' + a.successText + "</p>"),
                                      setTimeout(function () {
                                          i.find(".form__sys-message").fadeOut().delay(3e3).remove(), a.autoClose && r.magnificPopup.close();
                                      }, a.autoCloseDelay))
                                    : t(2 == e ? a.errorNocaptcha : 3 == e ? a.errorCaptcha : a.errorSubmit),
    ...
    jQuery(document).ready(function (e) {
        e("#feedbackForm").simpleSendForm({ successTitle: "Your message has been sent successfully!", successText: "We will contact you shortly.", captcha: !1, mailUrl: "/forms/submit.php" });
    }),
    ...
    (function (e) {
        ...
        (e.prototype = {
            ...
            open: function (e) {
                ...
                if (!u.isOpen) {
                    (u.types = []),
                        ...
                        u.bgOverlay ||
                            ((u.bgOverlay = w("bg").on("click" + h, function () {
                                u.close();
                            })),
                            (u.wrap = w("wrap")
                                .attr("tabindex", -1)
                    ...
                    x("BeforeOpen"),
                        u.st.showCloseBtn &&
                            (u.st.closeBtnInside
                                ? (b(m, function (e, t, i, n) {
                                      i.close_replaceWith = I(n.type);
                                  }),
                                  (f += " mfp-close-btn-in"))
                                : u.wrap.append(I())),
                        u.st.alignTop && (f += " mfp-align-top"),
                        u.fixedContentPos ? u.wrap.css({ overflow: u.st.overflowY, overflowX: "hidden", overflowY: u.st.overflowY }) : u.wrap.css({ top: C.scrollTop(), position: "absolute" }),
                        (!1 === u.st.fixedBgPos || ("auto" === u.st.fixedBgPos && !u.fixedContentPos)) && u.bgOverlay.css({ height: p.height(), position: "absolute" }),
                        u.st.enableEscapeKey &&
                            p.on("keyup" + h, function (e) {
            ...
            updateItemHTML: function () {
                ...
                if ((x("BeforeChange", [u.currItem ? u.currItem.type : "", t]), (u.currItem = e), !u.currTemplate[t])) {
                    ...
                    x("FirstMarkupParse", i), (u.currTemplate[t] = !i || d(i));
                }
                o && o !== e.type && u.container.removeClass("mfp-" + o + "-holder");
                var n = u["get" + t.charAt(0).toUpperCase() + t.slice(1)](e, u.currTemplate[t]);
                u.appendContent(n, t), (e.preloaded = !0), x(r, e), (o = e.type), u.container.prepend(u.contentContainer), x("AfterChange");
            },
            appendContent: function (e, t) {
                (u.content = e) ? (u.st.showCloseBtn && u.st.closeBtnInside && !0 === u.currTemplate[t] ? u.content.find(".mfp-close").length || u.content.append(I()) : (u.content = e)) : (u.content = ""),
                    x("BeforeAppend"),
            ...
            parseEl: function (e) {
                var t,
                    i = u.items[e];
                if ((i.tagName ? (i = { el: d(i) }) : ((t = i.type), (i = { data: i, src: i.src })), i.el)) {
                ...
                return (i.type = t || u.st.type || "inline"), (i.index = e), (i.parsed = !0), (u.items[e] = i), x("ElementParse", i), u.items[e];
            },
                ...
                t.data && (e = d.extend(t.data, e)),
                    ...
                    d.each(e, function (e, t) {
                        ...
                        if (1 < (a = e.split("_")).length) {
                            ...
                            if (0 < i.length) {
                                var n = a[1];
                                "replaceWith" === n ? i[0] !== t[0] && i.replaceWith(t) : "img" === n ? (i.is("img") ? i.attr("src", t) : i.replaceWith(d("<img>").attr("src", t).attr("class", i.attr("class")))) : i.attr(a[1], t);
                            }
            ...
            (d.magnificPopup = {
                ...
                modules: [],
                open: function (e, t) {
                    return _(), ((e = e ? d.extend(!0, {}, e) : {}).isObj = !0), (e.index = t || 0), this.instance.open(e);
                },
                close: function () {
            ...
            (d.fn.magnificPopup = function (e) {
                ...
                if ("string" == typeof e)
                    if ("open" === e) {
                        var i,
                            n = y ? t.data("magnificPopup") : t[0].magnificPopup,
                            o = parseInt(arguments[1], 10) || 0;
                        n.items ? (i = n.items[o]) : ((i = t), n.delegate && (i = i.find(n.delegate)), (i = i.eq(o))), u._openClick({ mfpEl: i }, t, n);
                ...
                getInline: function (e, t) {
                    if ((E(), e.src)) {
                        ...
                        if (n.length) {
                            ...
                            o && o.tagName && (k || ((T = i.hiddenClass), (k = w(T)), (T = "mfp-" + T)), (S = n.after(k).detach().removeClass(T))), u.updateStatus("ready");
        ...
        d.magnificPopup.registerModule(O, {
            ...
            proto: {
                initAjax: function () {
                    u.types.push(O), (z = u.st.ajax.cursor), b(c + "." + O, B), b("BeforeChange." + O, B);
                },
                getAjax: function (o) {
        ...
        d.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                _onImageHasSize: function (e) {
                    e.img && ((e.hasSize = !0), A && clearInterval(A), (e.isCheckingImgSize = !1), x("ImageHasSize", e), e.imgHidden && (u.content && u.content.removeClass("mfp-loading"), (e.imgHidden = !1)));
                },
                        ...
                        o = function (e) {
                            A && clearInterval(A),
                                (A = setInterval(function () {
                                    0 < n.naturalWidth ? u._onImageHasSize(t) : (200 < i && clearInterval(A), 3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500));
                                }, e));
                        };
                    o(1);
                },
                getImage: function (e, t) {
                    var i = 0,
                        n = function () {
                            e &&
                                (e.img[0].complete
                                    ? (e.img.off(".mfploader"), e === u.currItem && (u._onImageHasSize(e), u.updateStatus("ready")), (e.hasSize = !0), (e.loaded = !0), x("ImageLoadComplete"))
                                    : ++i < 200
                                    ? setTimeout(n, 100)
                                    : o());
                        },
                    ...
                    return (
                        ...
                        u.resizeImage(),
                        e.hasSize
                            ? (A && clearInterval(A), e.loadError ? (t.addClass("mfp-loading"), u.updateStatus("error", a.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), u.updateStatus("ready")))
        ...
        d.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                                    ...
                                    (i = setTimeout(function () {
                                        n.css(u._getOffset(!0)),
                                            (i = setTimeout(function () {
                                                s(),
                                                    setTimeout(function () {
                                                        n.remove(), (e = n = null), x("ZoomAnimationEnded");
                                                    }, 16);
                                            }, o));
                                    }, 16));
                            }
                ...
                _getOffset: function (e) {
                    ...
                    var a = { width: t.width(), height: (y ? t.innerHeight() : t[0].offsetHeight) - o - n };
                    return void 0 === F && (F = void 0 !== document.createElement("p").style.MozTransform), F ? (a["-moz-transform"] = a.transform = "translate(" + i.left + "px," + i.top + "px)") : ((a.left = i.left), (a.top = i.top)), a;
                },
            },
        });
        var L = "iframe",
            H = function (e) {
                if (u.currTemplate[L]) {
                    var t = u.currTemplate[L].find("iframe");
        ...
        d.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function () {
                    var a = u.st.gallery,
                        e = ".mfp-gallery";
                    if (((u.direction = !0), !a || !a.enabled)) return !1;
                    (f += " mfp-gallery"),
                        b(g + e, function () {
                        ...
                        b(m + e, function (e, t, i, n) {
                            var o = u.items.length;
                            i.counter = 1 < o ? N(a.tCounter, n.index, o) : "";
                        }),
                        b("BuildControls" + e, function () {
                            if (1 < u.items.length && a.arrows && !u.arrowLeft) {
                                var e = a.arrowMarkup,
                                    ...
                                    i = (u.arrowRight = d(e.replace(/%title%/gi, a.tNext).replace(/%dir%/gi, "right")).addClass(s));
                                t.click(function () {
                                    u.prev();
                                }),
                                    i.click(function () {
